...
# filePath = 'JAOliveira_vf047.msh'
# filePath = 'JAOliveira_vf047_015.msh'
# filePath = 'JAOliveira_vf047_02.msh'
# filePath = 'JAOliveira_vf047_031.msh'
# filePath = 'JAOliveira_vf047_033.msh'
# filePath = 'JAOliveira_vf047_04.msh'
# filePath = 'JAOliveira_vf047_05.msh'
filePath = 'unit_cell.inp'
...
# print(len(points))
if dim == 2:
    points = np.delete(points, 2, axis=1)  # Remove z column
...
meshio.write(
    "xdmf/mesh.xdmf",
    meshio.Mesh(points,
                cells={element_types[0]: msh.cells_dict[element_types[0]]}))
# meshio.write(
#     "xdmf/subdomains.xdmf",
#     meshio.Mesh(
#         points,
#         cells={element_types[1]: msh.cells_dict[element_types[1]]},
#         cell_data={"name_to_read": [msh.cell_data["gmsh:physical"][1]]}))
# meshio.write(
#     "xdmf/boundaries.xdmf",
#     meshio.Mesh(
#         points,
#         cells={element_types[0]: msh.cells_dict[element_types[0]]},
...
# print(len(msh.cell_data["gmsh:physical"]))
...
# sideset_list = set(msh.cell_data["gmsh:physical"][1])
...
File(f"{fileName}.xml") << mesh
# File(f"data_gmsh/{fileName}_physical_region.xml") << subdomains
# File(f"data_gmsh/{fileName}_facet_region.xml") << boundaries
